    ...
    <footer class="bg-white">
      <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div class="text-center">
          <h2 class="text-3xl font-extrabold text-gray-900 sm:text-5xl">DevArt</h2>

          <p class="mx-auto mt-4 max-w-sm text-gray-500">
            Programming Related Articles Daily ❤️
          </p>
        ...
        >
          <ul class="flex flex-wrap justify-center gap-4 text-xs lg:justify-end">
            <li>
              <Link href="/devart/guidelines-and-terms-of-service-tos-4khk" class="text-gray-500 transition hover:opacity-75"> Terms & Conditions </Link>
            </li>
            ...
            <li>
              <Link href="/devart" class="text-gray-500 transition hover:opacity-75"> DevArt </Link>
            </li>
            <li>
              <Link href="/api/sitemap" class="text-gray-500 transition hover:opacity-75">Visual Sitemap</Link>
            </li>
            <li>
              <Link href="/sitemapsh" class="text-gray-500 transition hover:opacity-75">Sitemap</Link>
            </li>
